	...
	var emptyFn = function(){},
		Notifier = Backbone.Notifier = Backbone.Model.extend({
			defaults: {
				...
				'closeBtn': true,
				'title': '警告',		// notification title, if defined causes the notification to be 'dialog' (unless dialog is 'false')
				'hideOnClick': true,	// whether to hide the notifications on mouse click
				'type': 'info',       	// default notification style (null / 'warning' / 'error' / 'info' / 'success')
				'cls': null,      		// additional css class
				'ms': 1000,			// milliseconds before hiding
				'loader': false,		// whether to display loader animation in notifactions
				'destroy': true,		// notification or selector of nofications to hide on show
				'modal': false,			// whether to dark and block the UI behind the nofication
				'opacity': 1,			// opacity of nofications
				'offsetY': -550,				// distance between the notifications and the top/bottom edge
				...
				'width': 'auto',		// notification's width
